...
public class DropdownRootTests implements TestsInit {
    ...
    public void negativeDropdownTest() {
        try {
            ...
            assertThat(safeException(ex), containsString("Can't find Element 'MetalAndColorsPage.colorsRoot (>css='div[ui=dropdown]'>xpath='(//div[@ui='dropdown']//li)[.='GreyBrownCrimson']')' during 1 second(s)"));
        }
    }
